...
function SubContent() {
  return (
    <div className=' lg:flex-row mx-10 mt-10 flex flex-col justify-around'>
       ...
       <div style={{ backgroundColor: '#014D86' }} className=" lg:m-0 mx-auto mb-5 relative overflow-visible rounded-tl-3xl rounded-lg w-96 h-80">
        ...
        <p className="text-white  text-xl mt-4 mx-2 overflow-hidden ">I prioritize tasks effectively, ensuring that projects are completed on time and within budget. My efficient use of time allows me to meet deadlines without compromising on quality.</p>
       </div>
       ...
       <div style={{ backgroundColor: '#014D86' }} className=" mb-5 lg:m-0 mx-auto relative overflow-visible rounded-tl-3xl rounded-lg w-96 h-80">
        ...
        <h2 className="text-white font-bold	 text-3xl bold mt-24 mx-2 ">Problem-solving skills</h2>
        <p className="text-white  text-xl mt-4 mx-2 ">I possess strong problem-solving skills that enable me to develop creative solutions for complex challenges, consistently meeting and exceeding project requirements.</p>
       </div>
