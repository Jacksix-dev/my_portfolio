...
function MainContent() {
  return (
    <div className='grid grid-cols-2'>
        ...
        <button type="button" className=" mt-5 mx-auto button  w-1/5 mb-2">Contactame</button>
        </div>
    ...
    >
      <img className="rounded-full object-cover w-80 border-4 border-cyan-400 h-80 place-self-center" src={portraitImage}  />
